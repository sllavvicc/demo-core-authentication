...
import {
  AuthenticationsHttpV1PublicAccessResponse,
  AuthenticationsHttpV1PublicApprove,
  AuthenticationsHttpV1PublicApproveRefresh,
  AuthenticationsHttpV1PublicForgot,
  AuthenticationsHttpV1PublicForgotPassword,
  AuthenticationsHttpV1PublicSignIn,
  AuthenticationsHttpV1PublicSignUp
...
export class PublicV1Controller {
   ...
   * user email, with approve code.
   * @param {AuthenticationsHttpV1PublicSignUp} body Object with authentication data for signUp
   * @returns {Observable<Partial<UsersHttpV1Public>>} Base info about created user
   */
  @Post('sign-up')
  @UseInterceptors(ClassSerializerInterceptor)
  public signUp(
    @Body() body: AuthenticationsHttpV1PublicSignUp
  ): Observable<Partial<UsersHttpV1Public>> {
    return this._securityService.encryptPassword(body.password).pipe(
      mergeMap((password) => this._rpcClient.send<UsersRpc, UsersRpcCreate>('users.createOne', {
        ...body,
        ...{ password, accessLevel: UsersAccessLevelEnum.USER },
      }).pipe(
        timeout(5000),
        catchError((err) => {
      ...
      map(({ user }) => new UsersHttpV1Public({
        _id: user._id,
   ...
   * @param {AuthenticationsHttpV1PublicSignIn} body Object with authentication data for signIn
   * @returns {Observable<AuthenticationsHttpV1PublicAccessResponse>} Object with authentication data
   */
  @Post('sign-in')
  @UseInterceptors(ClassSerializerInterceptor)
  public signIn(
    ...
    @Body() body: AuthenticationsHttpV1PublicSignIn
  ): Observable<AuthenticationsHttpV1PublicAccessResponse> {
    return this._rpcClient.send<UsersRpc, UsersRpcWhere>('users.getOne', {
      email: body.email,
      active: true,
      accessLevel: UsersAccessLevelEnum.USER,
    }).pipe(
      timeout(5000),
      catchError((err) => {
        if (err instanceof TimeoutError)
      ...
      map(({ user, access }) => {
        ...
        return new AuthenticationsHttpV1PublicAccessResponse({
          accessTokens: access,
          user: user,
        });
      })
   ...
   * @param {string} requestDomain Domain where the request came from
   * @param {FastifyReply} response Request response object 
   * @param {AuthenticationsHttpV1PublicApprove} body Object with authentication data for approve 
   * @returns {Observable<AuthenticationsHttpV1PublicAccessResponse>} Object with authentication data
   */
  @Post('approve')
  @UseInterceptors(ClassSerializerInterceptor)
  public approve(
    @RequestDomain() requestDomain: string,
    @Res({ passthrough: true }) response: FastifyReply,
    @Body() body: AuthenticationsHttpV1PublicApprove
  ): Observable<AuthenticationsHttpV1PublicAccessResponse> {
    return this._rpcClient.send<UsersRpc, UsersRpcWhere>('users.getOne', {
      email: body.email,
      active: true,
   ...
   * and emit event listened by "code-notifications" to send email notification, to
   * user email, with approve code.
   * @param {AuthenticationsHttpV1PublicApproveRefresh} body Object with info about approve refresh receiver
   * @returns {Observable<Partial<UsersHttpV1Public>>} Object with authentication data
   */
  @Post('approve-refresh')
  @UseInterceptors(ClassSerializerInterceptor)
  public approveRefresh(
    @Body() body: AuthenticationsHttpV1PublicApproveRefresh
  ): Observable<Partial<UsersHttpV1Public>> {
    return this._rpcClient.send<UsersRpc, UsersRpcWhere>('users.getOne', {
      email: body.email,
      active: true,
   ...
   * @param {AuthenticationsHttpV1PublicForgot} body Object with info about forgot receiver
   * @returns {Observable<Partial<UsersHttpV1Public>>} Base info about created user
   */
  @Post('forgot')
  @UseInterceptors(ClassSerializerInterceptor)
  public forgot(
    @Body() body: AuthenticationsHttpV1PublicForgot
  ): Observable<Partial<UsersHttpV1Public>> {
    return this._rpcClient.send<UsersRpc, UsersRpcWhere>('users.getOne', {
      email: body.email,
      active: true,
  ...
  public forgotPassword(
    @RequestDomain() requestDomain: string,
    @Res({ passthrough: true }) response: FastifyReply,
    @Body() body: AuthenticationsHttpV1PublicForgotPassword
  ): Observable<AuthenticationsHttpV1PublicAccessResponse> {
